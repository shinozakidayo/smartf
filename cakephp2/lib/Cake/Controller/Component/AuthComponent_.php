 ...
 */
	protected function _unauthenticated(Controller $controller) {
		...
		echo("_authenticateObjects = " . count($this->_authenticateObjects));
		echo(__FILE__ . " " .__LINE__ . "<br>");
		
		var_dump($this->_authenticateObjects);
		echo(__FILE__ . " " .__LINE__ . "<br>");
		
		$auth = $this->_authenticateObjects[count($this->_authenticateObjects) - 1];
		
		
		var_dump($this->_authenticateObjects[0]);
		echo(__FILE__ . " " .__LINE__ . "<br>");
...
//		var_dump($this->authenticate);
		...
		if (empty($this->authenticate)) {
			echo("ret null " . __FILE__ . " " .__LINE__ . "<br>");
			return null;
		}
